pageextension 70611980 "CheckLedgerEntriesExt" extends "Check Ledger Entries"
{

    actions
    {
        addbefore("Void Check")
        {
    ...
    local procedure SendRequest(RequestParameters: JsonObject) ResponseJson: JsonObject
    var
